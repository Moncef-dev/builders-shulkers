...
// shared handlers' threading contract. (The Litematica interop of the 26.x branch is deferred on this branch, so
// there is no compat registration here yet; it will return with its own dependency pins when re-tested.)
